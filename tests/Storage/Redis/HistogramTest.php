...
class HistogramTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->redis->hSet('phpunit:foo_bar_baz_sum', ArrayStorage::DEFAULT_VALUE_INDEX, 228);
        $this->redis->hSet('phpunit:foo_bar_baz_sum', '{"foo":"bar"}', 467);
        $this->redis->hSet('phpunit:foo_bar_baz_sum', '{"foo":"baz"}', 85);
